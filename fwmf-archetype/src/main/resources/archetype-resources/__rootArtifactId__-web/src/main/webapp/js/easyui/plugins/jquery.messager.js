...
var tb = $("<div class=\"messager-button\"></div>").appendTo(win);
var closeBtn = $("<a></a>").attr("href", "javascript:void(0)").text("关闭").css("margin-left", 10);
closeBtn.click(function() {$.messager.progress('close');if (_1f.abort) {_1f.abort();}}).appendTo(tb).linkbutton()
return win;
}};
