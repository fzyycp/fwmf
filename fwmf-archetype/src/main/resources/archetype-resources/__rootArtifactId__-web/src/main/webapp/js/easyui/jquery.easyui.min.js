		...
		function _6eb(tr, _6ec) {
			$(
					"<tr class=\"treegrid-tr-tree\">"
							+ "<td style=\"border:0px;height:auto;\" colspan=\"" + _6ec
							+ "\">" + "<div></div>" + "</td>" + "</tr>")
					.insertAfter(tr);
		}
		;
								...
								for ( var i = 0; i < _753.length; i++) {
									...
									if (row.children && row.children.length) {
										...
										var v = row.state == "closed" ? "none"
												: "block";
										_754
												.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px;height:auto\" colspan="
