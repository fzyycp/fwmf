...
_37(tr2,_36);
function _37(tr,_38){
$("<tr class=\"treegrid-tr-tree\">"+"<td style=\"border:0px;height:auto;\" colspan=\""+_38+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
};
};
...
_c7.push("<tr class=\"treegrid-tr-tree\"><td style=\"border:0px;height:auto;\" colspan="+(_be.length+(_bd.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
_c7=_c7.concat(tt);
_c7.push("</div></td></tr>");
}
}
